...
class ShaderList:
    ...
    def make(self, fname, name=""):
        ...
        :param fname: base filename for shader files
        :param name: name to use for this shader (defaults to fname)
        :raises: fofix.core.Shader.ShaderCompilationError
        """
    ...
    def compileShader(self, source, shaderType):
        ...
        :param source: file object open to shader source code
            (or something else returning lines of GLSL code when iterated over)
        :param shaderType: GL_VERTEX_SHADER_ARB or GL_FRAGMENT_SHADER_ARB
        :raises: fofix.core.Shader.ShaderCompilationError
    ...
    def compile(self, vertexSource, fragmentSource):
        ...
        :param vertexSource: file object open to vertex shader source code
        :param fragmentSource: file object open to fragment shader source code
        :raises: fofix.core.Shader.ShaderCompilationError
    ...
    def getVars(self, fname, program, sArray):
        ...
        :param fname: shader filename
        :param program: OpenGL program object compiled from that shader file
        :param sArray: dictionary to add variable information to
        """
    ...
    def setTexture(self, name, texture, program=None):
        ...
        for i, p_textures in enumerate(program["textures"]):
            if p_textures[0] == name:
                program["textures"][i] = (p_textures[0], p_textures[1], texture)
                return True
        return False
    ...
    def getVar(self, var="program", program=None):
        ...
        :param program: shader name, or None (default) for the currently active shader
    ...
    def setVar(self, var, value, program=None):
        ...
        :param program: shader name, or None (default) for the currently active shader
        :raises: KeyError if the variable does not exist
        :raises: TyperError it the value type is unsupported
        """
    ...
    def log(self, shader):
        ...
        :param shader: object to get log from
        :returns: a string containing the log, None it there is no log
        """
    ...
    def set(self, dir):
        ...
        :param dir: directory to load shaders from
        """

        # check whether all needed extensions are actually supported
