...
class Theme(Task):  
  def __init__(self, path, name):
    ...
    if not os.path.exists(self.themePath):
      ...
      def get(value, type = str, default = None):
        if os.path.exists(os.path.join(self.themePath, "theme.ini")):
            if self.config.has_option("theme", value):
              if type == "color":
                return self.hexToColor(self.get(value))
              else:
                return type(self.get(value))
        return default
      ...
      #Loading phrases
      self.loadingPhrase = get("loading_phrase",    str)
      self.resultsPhrase = get("results_phrase",    str)
      ...
      self.power_up_name = get("theme", "power_up_name", str, "Jurgen Power")
      ...
      self.neck_prompt_x = get("menu_neck_choose_x")
      self.neck_prompt_y = get("menu_neck_choose_y")
      ...
      self.fail_bkg_pos       = get("fail_bkg").split(",")
      self.fail_text_xPos     = get("fail_text_x")
      self.fail_text_yPos     = get("fail_text_y")
      self.fail_songname_xPos = get("fail_songname_x") 
      self.fail_songname_yPos = get("fail_songname_y") 
      ...
      #main menu system
      self.menuX = get("menu_x")
      self.menuY = get("menu_y")
      self.menuRB = get("rbmenu")
      self.loadingX = get("loading_x")
      self.loadingY = get("loading_y")
      self.loadingColor = self.hexToColor(get("loading_text_color"))
      self.loadingFScale = get("loading_font_scale")
      self.loadingRMargin = get("loading_right_margin")
      self.loadingLSpacing = config.get ("theme", "loading_line_spacing")
      self.main_menu_scaleVar = get("main_menu_scale")
      self.main_menu_vspacingVar = get("main_menu_vspacing")
      self.use_solo_submenu = get("use_solo_submenu")
      self.sub_menu_xVar = get("sub_menu_x")
      self.sub_menu_yVar = get("sub_menu_y")
      self.songback = get("songback")
      self.versiontag = get("versiontag")
      self.shadowoffsetx = get("shadowoffsetx")
      self.shadowoffsety = get("shadowoffsety")
      self.menuTipTextY = get("menu_tip_text_y")
      self.menuTipTextFont = get("menu_tip_text_font")
      self.menuTipTextScale = get("menu_tip_text_scale")
      self.menuTipTextColor = self.hexToColorResults(get("menu_tip_text_color"))
      self.menuTipTextScrollSpace = get("menu_tip_text_scroll_space")
      self.menuTipTextScrollMode = get("menu_tip_text_scroll_mode")
      self.menuTipTextDisplay = get("menu_tip_text_display")
      
      #Lobby
      self.controlActivateX = get("control_activate_x")
      self.controlActivateSelectX = get("control_activate_select_x")
      self.controlActivatePartX = get("control_activate_part_x")
      self.controlActivateY = get("control_activate_y")
      self.controlActivateScale = get("control_activate_scale")
      self.controlActivateSpace = get("control_activate_space")
      self.controlActivatePartSize = get("control_activate_part_size")
      self.controlActivateFont = get("control_activate_font")
      self.controlDescriptionX = get("control_description_x")
      self.controlDescriptionY = get("control_description_y")
      self.controlDescriptionScale = get("control_description_scale")
      self.controlDescriptionFont = get("control_description_font")
      self.controlCheckX = get("control_check_x")
      self.controlCheckY = get("control_check_y")
      self.controlCheckTextY = get("control_check_text_y")
      self.controlCheckPartMult = get("control_check_part_mult")
      self.controlCheckScale = get("control_check_scale")
      self.controlCheckSpace = get("control_check_space")
      self.controlCheckFont  = get("control_check_font")
      self.lobbyMode = get("lobby_mode")
      self.lobbyPreviewX = get("lobby_preview_x")
      self.lobbyPreviewY = get("lobby_preview_y")
      self.lobbyPreviewSpacing = get("lobby_preview_spacing")
      self.lobbyTitleX = get("lobby_title_x")
      self.lobbyTitleY = get("lobby_title_y")
      self.lobbyTitleCharacterX = get("lobby_title_character_x")
      self.lobbyTitleCharacterY = get("lobby_title_character_y")
      self.lobbyTitleScale = get("lobby_title_scale")
      self.lobbyTitleFont = get("lobby_title_font")
      self.lobbyAvatarX = get("lobby_avatar_x")
      self.lobbyAvatarY = get("lobby_avatar_y")
      self.lobbyAvatarScale = get("lobby_avatar_scale")
      self.lobbySelectX = get("lobby_select_x")
      self.lobbySelectY = get("lobby_select_y")
      self.lobbySelectImageX = get("lobby_select_image_x")
      self.lobbySelectImageY = get("lobby_select_image_y")
      self.lobbySelectScale = get("lobby_select_scale")
      self.lobbySelectSpace = get("lobby_select_space")
      self.lobbySelectFont = get("lobby_select_font")
      self.lobbySelectLength = get("lobby_select_length")
      self.lobbyTitleColor = self.hexToColor(get("lobby_title_color"))
      self.lobbyInfoColor = self.hexToColor(get("lobby_info_color"))
      self.lobbyFontColor = self.hexToColor(get("lobby_font_color"))
      self.lobbyPlayerColor = self.hexToColor(get("lobby_player_color"))
      self.lobbySelectColor = self.hexToColor(get("lobby_select_color"))
      self.lobbyDisableColor = self.hexToColor(get("lobby_disable_color"))
      self.characterCreateX = get("character_create_x")
      self.characterCreateY = get("character_create_y")
      self.characterCreateOptionX = get("character_create_option_x")
      self.characterCreateFontColor = self.hexToColor(get("character_create_font_color"))
      self.characterCreateSelectColor = self.hexToColor(get("character_create_select_color"))
      self.characterCreateHelpColor = self.hexToColor(get("character_create_help_color"))
      self.characterCreateHelpX = get("character_create_help_x")
      self.characterCreateHelpY = get("character_create_help_y")
      self.characterCreateHelpScale = get("character_create_help_scale")
      self.characterCreateOptionFont = get("character_create_option_font")
      self.characterCreateHelpFont = get("character_create_help_font")
      self.characterCreateScale = get("character_create_scale")
      self.characterCreateSpace = get("character_create_space")
      self.avatarSelectTextX = get("avatar_select_text_x")
      self.avatarSelectTextY = get("avatar_select_text_y")
      self.avatarSelectTextScale = get("avatar_select_text_scale")
      self.avatarSelectFont = get("avatar_select_font")
      self.avatarSelectAvX = get("avatar_select_avatar_x")
      self.avatarSelectAvY = get("avatar_select_avatar_y")
      self.avatarSelectWheelY = get("avatar_select_wheel_y")
      
      #Vocal mode
      self.vocalMeterSize = get("vocal_meter_size")
      self.vocalMeterX = get("vocal_meter_x")
      self.vocalMeterY = get("vocal_meter_y")
      self.vocalMultX  = get("vocal_mult_x")
      self.vocalMultY  = get("vocal_mult_y")
      self.vocalPowerX = get("vocal_power_x")
      self.vocalPowerY = get("vocal_power_y")
      self.vocalFillupCenterX = get("vocal_fillup_center_x")
      self.vocalFillupCenterY = get("vocal_fillup_center_y")
      self.vocalFillupInRadius = get("vocal_fillup_in_radius")
      self.vocalFillupOutRadius = get("vocal_fillup_out_radius")
      self.vocalFillupFactor = get("vocal_fillup_factor")
      self.vocalFillupColor = get("vocal_fillup_color")
      self.vocalCircularFillup = get("vocal_circular_fillup")
      self.vocalLaneSize = get("vocal_lane_size")
      self.vocalGlowSize = get("vocal_glow_size")
      self.vocalGlowFade = get("vocal_glow_fade")
      self.vocalLaneColor = self.hexToColorResults(get("vocal_lane_color"))
      self.vocalShadowColor = self.hexToColorResults(get("vocal_shadow_color"))
      self.vocalGlowColor = self.hexToColorResults(get("vocal_glow_color"))
      self.vocalLaneColorStar = self.hexToColorResults(get("vocal_lane_color_star"))
      self.vocalShadowColorStar = self.hexToColorResults(get("vocal_shadow_color_star"))
      self.vocalGlowColorStar = self.hexToColorResults(get("vocal_glow_color_star"))
      
      #3D Note/Fret rendering system
      self.twoDnote = get("twoDnote")
      self.twoDkeys = get("twoDkeys")
      self.threeDspin = get("threeDspin")
      self.fret_press = get("fret_press")
      self.noterot = [get("noterot"+str(i+1)) for i in range(5)]
      self.keyrot  = [get("keyrot"+str(i+1)) for i in range(5)]
      self.drumnoterot = [get("drumnoterot"+str(i+1)) for i in range(5)]
      self.drumkeyrot = [get("drumkeyrot"+str(i+1)) for i in range(5)]
      self.notepos = [get("notepos"+str(i+1)) for i in range(5)]
      self.keypos  = [get("keypos"+str(i+1)) for i in range(5)]
      self.drumnotepos = [get("drumnotepos"+str(i+1)) for i in range(5)]
      self.drumkeypos = [get("drumkeypos"+str(i+1)) for i in range(5)]
      
      #In-game rendering
      self.rockmeter_score_colorVar = self.hexToColorResults(get("rockmeter_score_color"))
      self.ingame_stats_colorVar = self.hexToColorResults(get("ingame_stats_color"))
      self.hopoIndicatorX = get("hopo_indicator_x")
      self.hopoIndicatorY = get("hopo_indicator_y")  
      self.hopoIndicatorActiveColor = self.hexToColor(get("hopo_indicator_active_color"))
      self.hopoIndicatorInactiveColor = self.hexToColor(get("hopo_indicator_inactive_color"))
      self.markSolos = get("mark_solo_sections")
      
      #Game results scene
      self.result_score = get("result_score").split(",")
      self.result_star = get("result_star").split(",")
      self.result_song = get("result_song").split(",")
      self.result_song_form = get("result_song_form")
      self.result_song_text = get("result_song_text").strip()
      self.result_stats_part = get("result_stats_part").split(",")
      self.result_stats_part_text = get("result_stats_part_text").strip()
      self.result_stats_name = get("result_stats_name").split(",")
      self.result_stats_diff = get("result_stats_diff").split(",")
      self.result_stats_diff_text = get("result_stats_diff_text").strip()
      self.result_stats_accuracy = get("result_stats_accuracy").split(",")
      self.result_stats_accuracy_text = get("result_stats_accuracy_text").strip()
      self.result_stats_streak = get("result_stats_streak").split(",")
      self.result_stats_streak_text = get("result_stats_streak_text").strip()
      self.result_stats_notes = get("result_stats_notes").split(",")
      self.result_stats_notes_text = get("result_stats_notes_text").strip()
      self.result_cheats_info = get("result_cheats_info").split(",")
      self.result_cheats_numbers = get("result_cheats_numbers").split(",")
      self.result_cheats_percent = get("result_cheats_percent").split(",")
      self.result_cheats_score   = get("result_cheats_score").split(",")
      self.result_cheats_color   = get("result_cheats_color")
      self.result_cheats_font    = get("result_cheats_font")
      self.result_high_score_font = get("result_high_score_font")
      self.result_menu_x         = get("result_menu_x")
      self.result_menu_y         = get("result_menu_y")
      self.result_star_type      = get("result_star_type")
