...
#Face-Off Rules
Config.define("rules", "face_off_style", int, 0, text = _("Face-Off Style"), options = {0: _("Head-to-Head"), 1: _("Face-Off")}, tipText = _("Sets the style of the one-on-one contest. Head-to-Head you both play the whole song, while in Face-Off you alternate phrases."))
