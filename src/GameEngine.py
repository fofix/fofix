...
Config.define("video",  "fps",          int,   120,    text = _("Frames per Second"), options = dict([(n, n) for n in range(1, 121)]), tipText = _("Set the number of frames to render per second. Higher values are better, but your computer may not be able to keep up. You probably can leave this alone. (This is affected by the 'Performance' quickset)"))
