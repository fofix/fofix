...
class Data(object):
  ...
  def __init__(self, resource, svg):
    ...
    font10    = lambda: Font(streakFont2, fontSize[2], scale = scale2 - .18, reversed = reversed, systemFont = not asciiOnly, outline = False, shadow = True) #blazingamer - Worldrave Modified (- .18)
