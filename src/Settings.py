...
class SettingsMenu(Menu.Menu):
  def __init__(self, engine):
    ...
    self.battleSettings = [
      (_("Battle Objects"), self.battleObjectSettingsMenu),
    ]
    ...
    self.debugSettings = [
      ...
      ConfigChoice(engine, engine.config, "debug",   "sqlite_timeout", autoApply = True),#volshebnyi
    ]
    ...
    self.cheats = [
      ...
      (_("Mod settings"), self.modSettingsMenu),
    ]
